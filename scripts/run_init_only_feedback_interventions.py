...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run targeted init-only feedback interventions on structured pruning dynamics."
    )
...
def _make_run_root(results_dir: str, dataset: str, model: str, init_seed: int) -> str:
    ...
    run_root = os.path.join(results_dir, dataset, model, "feedback_interventions", f"seed_{init_seed}", stamp)
